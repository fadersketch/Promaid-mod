...
public final class StorageBindingStore extends SavedData {
    ...
    private StorageBindingStore(CompoundTag tag) {
        ...
        for (int i = 0; i < maids.size(); i++) {
            ...
            net.minecraft.nbt.ListTag terms = e.contains(KEY_TERMINALS, 9)
                    ? e.getList(KEY_TERMINALS, 9) : new net.minecraft.nbt.ListTag();
    ...
    public static StorageBindingStore get(ServerLevel level) {
        return level.getDataStorage().computeIfAbsent(new net.minecraft.world.level.saveddata.SavedData.Factory<StorageBindingStore>(StorageBindingStore::new,
                        (t, registries) -> new StorageBindingStore(t),
