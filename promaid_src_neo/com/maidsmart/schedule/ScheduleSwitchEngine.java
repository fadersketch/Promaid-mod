    ...
    public static Result applySegment(EntityMaid maid, ServerLevel level,
        ...
        try {
            ...
            if (fail == null && seg.taskUid() != null && !seg.taskUid().isEmpty()) {
                ...
                try {
                    if (seg.taskUid() == null || net.minecraft.resources.ResourceLocation.tryParse(seg.taskUid()) == null) {
                        ...
                        if (found.isPresent()) {
                            ...
                            if (fromUid.equals(toUid)) {
                            ...
                            } else if (!ScheduleSwitchState.canSwitchNormally(maid.getUUID(), nowTick,
                            ...
                            } else if (ScheduleSwitchState.shouldSuppressReverseSwitch(maid.getUUID(),
                                ...
                                ScheduleSwitchGuard.runInternal(maid.getUUID(), target.getUid(),
                                        () -> maid.setTask(target));
                                ...
                                if (!seg.taskUid().equals(cur)) {
                                    ...
                                    ScheduleSwitchState.recordSwitch(maid.getUUID(), fromUid, toUid,
                                            nowTick,
                                            com.maidsmart.config.MaidSmartConfig.MISC_SCHEDULE_REVERSE_WINDOW_TICKS.get());
                                }
                            }
