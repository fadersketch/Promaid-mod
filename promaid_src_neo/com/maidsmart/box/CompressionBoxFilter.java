...
public final class CompressionBoxFilter {
     ...
     *
     * 【为什么附魔书要单独判】1.21.1 的 {@code ItemStack.isEnchanted()}（javap 实证）
     * 只看 {@code DataComponents.ENCHANTMENTS}：附魔书把附魔存在
     * {@code DataComponents.STORED_ENCHANTMENTS}，所以一本附魔书在它眼里是「没附魔的」。
     * 判物品类型（{@code EnchantedBookItem}）比去读那个组件更稳——空白的附魔书也一并挡住，
     * 反正那玩意本来就没用。
     */
