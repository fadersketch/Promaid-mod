...
public final class MaidArmyCommand {
    ...
    public static void register(com.mojang.brigadier.CommandDispatcher<net.minecraft.commands.CommandSourceStack> dispatcher) {
        dispatcher.register(net.minecraft.commands.Commands.literal("maid_smart") // literal
                ...
                .then(net.minecraft.commands.Commands.literal("stroll")
                        .then(net.minecraft.commands.Commands.literal("check")
                                ...
                                .then(net.minecraft.commands.Commands.argument("maid", // argument
                                        ...
                                        .executes(ctx -> strollCheck(ctx.getSource(),
                                                net.minecraft.commands.arguments.EntityArgument
                                                        .getEntity(ctx, "maid")))))
                        .then(net.minecraft.commands.Commands.literal("go")
                                ...
                                .then(net.minecraft.commands.Commands.argument("maid", // argument
                                        ...
                                        .executes(ctx -> strollGo(ctx.getSource(),
                                                net.minecraft.commands.arguments.EntityArgument
                                                        .getEntity(ctx, "maid")))))
                        .then(net.minecraft.commands.Commands.literal("speed")
                                .then(net.minecraft.commands.Commands.argument("value", // argument
    ...
    private static int strollCheck(net.minecraft.commands.CommandSourceStack source,
        ...
        java.util.List<Component> lines =
                com.maidsmart.task.MaidStrollCheck.run(source.getLevel(), maid);
    ...
    private static int strollGo(net.minecraft.commands.CommandSourceStack source,
        ...
        com.github.tartaricacid.touhoulittlemaid.entity.passive.EntityMaid maid =
                entity instanceof com.github.tartaricacid.touhoulittlemaid.entity.passive.EntityMaid m
                        ? m : null;
        java.util.List<Component> lines =
                com.maidsmart.task.MaidStrollCheck.go(source.getLevel(), maid);
        for (Component line : lines) {
            source.sendSuccess(() -> line, false);
            com.maidsmart.tool.PromaidLog.log(com.maidsmart.task.MaidStrollCheck.CAT, line.getString());
        }
