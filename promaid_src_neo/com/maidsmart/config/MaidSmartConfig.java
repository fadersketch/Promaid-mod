...
public static final ModConfigSpec.BooleanValue BUILD_REAL_GHOST_BLOCKS;
/** 实测五百五十三①：投影每帧绘制上限（真方块模型比填充盒重） */
public static final ModConfigSpec.IntValue BUILD_GHOST_BLOCK_CAP;
/** 实测五百五十三②：落点微调允许的最远距离（超过则服务端拒绝开建） */
public static final ModConfigSpec.IntValue BUILD_PLACEMENT_RANGE;
