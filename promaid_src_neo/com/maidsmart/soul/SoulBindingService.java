...
public final class SoulBindingService {
    ...
    public static String getSoulId(EntityMaid maid) {
        String v = ((net.neoforged.neoforge.common.extensions.IEntityExtension) maid).getPersistentData().getString(NBT_KEY);
    ...
    public static com.maidsmart.memory.AiMemoryStore storeFor(EntityMaid maid, ServerLevel level) {
        ...
        Path root = soul != null ? soul : com.maidsmart.memory.AiMemoryExtractor.memoryRoot(level.getServer());
        return com.maidsmart.memory.AiMemoryStore.of(maid.getUUID(), root, worldName(level));
    }
