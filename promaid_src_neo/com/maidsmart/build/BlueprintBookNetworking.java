        ...
        try {
            ...
            try {
                if (!com.maidsmart.config.MaidSmartConfig.MEMORY_HEARTFELT_ANNIVERSARY.get()) {
                    ...
                    long confession = ((net.neoforged.neoforge.common.extensions.IEntityExtension) maid).getPersistentData().getLong("heartfelt_confession_at");
                    long firstMeet = ((net.neoforged.neoforge.common.extensions.IEntityExtension) maid).getPersistentData().getLong("heartfelt_ev_first_meet");
