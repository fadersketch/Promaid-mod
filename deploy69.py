...
SRC = r"C:\Users\Sketch\.zcode\workspace\default\promaid-mod\patched\promaid-1.2.4-forge-1.20.1.jar"
...
DST = r"D:\.minecraft\versions\1.20.1-Forge_47.4.21\mods\promaid-1.2.4-forge-1.20.1.jar"
...
tmp = os.path.join(tempfile.gettempdir(), "promaid-1.2.4-forge-1.20.1.jar")
