...
public final class BlueprintBookNetworking {
    ...
    public static void register() {
        CHANNEL.registerMessage(0, BlueprintBookBuildPackets.OpenBlueprintBookPacket.class,
                BlueprintBookBuildPackets.OpenBlueprintBookPacket::encode, BlueprintBookBuildPackets.OpenBlueprintBookPacket::decode,
                BlueprintBookBuildPackets.OpenBlueprintBookPacket::handle);
        CHANNEL.registerMessage(1, BlueprintBookBuildPackets.SelectBlueprintPacket.class,
                BlueprintBookBuildPackets.SelectBlueprintPacket::encode, BlueprintBookBuildPackets.SelectBlueprintPacket::decode,
                BlueprintBookBuildPackets.SelectBlueprintPacket::handle);
        // v1.5.43：手册控制面板（全员加入/暂停/速度/强制续建/进度/取消/逐只暂停）
        CHANNEL.registerMessage(2, BlueprintBookBuildPackets.BuildControlPacket.class,
                BlueprintBookBuildPackets.BuildControlPacket::encode, BlueprintBookBuildPackets.BuildControlPacket::decode,
                BlueprintBookBuildPackets.BuildControlPacket::handle);
        // v1.5.62：S2C 状态刷新（进度/速度/暂停/女仆状态面板内即时更新）
        CHANNEL.registerMessage(3, BlueprintBookBuildPackets.ProgressUpdatePacket.class,
                BlueprintBookBuildPackets.ProgressUpdatePacket::encode, BlueprintBookBuildPackets.ProgressUpdatePacket::decode,
                BlueprintBookBuildPackets.ProgressUpdatePacket::handle);
        // v1.5.86：AI 记忆 per-maid 开关（调试面板按钮 → 服务端写 TaskData）
        CHANNEL.registerMessage(4, BlueprintBookEntityPackets.AiMemoryTogglePacket.class,
                BlueprintBookEntityPackets.AiMemoryTogglePacket::encode, BlueprintBookEntityPackets.AiMemoryTogglePacket::decode,
                BlueprintBookEntityPackets.AiMemoryTogglePacket::handle);
        // v1.5.94：删除蓝图（手册删除按钮，服务端删 config/存档文件 + 清缓存）
        CHANNEL.registerMessage(5, BlueprintBookEntityPackets.DeleteBlueprintPacket.class,
                BlueprintBookEntityPackets.DeleteBlueprintPacket::encode, BlueprintBookEntityPackets.DeleteBlueprintPacket::decode,
                BlueprintBookEntityPackets.DeleteBlueprintPacket::handle);
        // v1.5.95：查看女仆记忆（手册"女仆记忆"页：C2S 请求 + S2C 下发）
        CHANNEL.registerMessage(6, BlueprintBookEntityPackets.MemoryViewRequestPacket.class,
                BlueprintBookEntityPackets.MemoryViewRequestPacket::encode, BlueprintBookEntityPackets.MemoryViewRequestPacket::decode,
                BlueprintBookEntityPackets.MemoryViewRequestPacket::handle);
        CHANNEL.registerMessage(7, BlueprintBookEntityPackets.MemoryViewResponsePacket.class,
                BlueprintBookEntityPackets.MemoryViewResponsePacket::encode, BlueprintBookEntityPackets.MemoryViewResponsePacket::decode,
                BlueprintBookEntityPackets.MemoryViewResponsePacket::handle);
        // v1.5.103：清空女仆记忆（手册记忆页"清空记忆"按钮）
        CHANNEL.registerMessage(8, BlueprintBookEntityPackets.ClearMemoryPacket.class,
                BlueprintBookEntityPackets.ClearMemoryPacket::encode, BlueprintBookEntityPackets.ClearMemoryPacket::decode,
                BlueprintBookEntityPackets.ClearMemoryPacket::handle);
        // v1.5.192：女仆工作链路调试面板（Promaid 手册）——请求快照 / 下发快照 / 调试动作
        CHANNEL.registerMessage(9, BlueprintBookEntityPackets.MaidDebugRequestPacket.class,
                BlueprintBookEntityPackets.MaidDebugRequestPacket::encode, BlueprintBookEntityPackets.MaidDebugRequestPacket::decode,
                BlueprintBookEntityPackets.MaidDebugRequestPacket::handle);
        CHANNEL.registerMessage(10, BlueprintBookEntityPackets.MaidDebugResponsePacket.class,
                BlueprintBookEntityPackets.MaidDebugResponsePacket::encode, BlueprintBookEntityPackets.MaidDebugResponsePacket::decode,
                BlueprintBookEntityPackets.MaidDebugResponsePacket::handle);
        CHANNEL.registerMessage(11, BlueprintBookEntityPackets.MaidDebugActionPacket.class,
                BlueprintBookEntityPackets.MaidDebugActionPacket::encode, BlueprintBookEntityPackets.MaidDebugActionPacket::decode,
                BlueprintBookEntityPackets.MaidDebugActionPacket::handle);
        // v1.5.198：系统语音包导入 / 查询（重载、状态）——设置面板"语音"页
        CHANNEL.registerMessage(12, BlueprintBookEntityPackets.VoicePackImportPacket.class,
                BlueprintBookEntityPackets.VoicePackImportPacket::encode, BlueprintBookEntityPackets.VoicePackImportPacket::decode,
                BlueprintBookEntityPackets.VoicePackImportPacket::handle);
        CHANNEL.registerMessage(13, BlueprintBookEntityPackets.VoicePackQueryPacket.class,
                BlueprintBookEntityPackets.VoicePackQueryPacket::encode, BlueprintBookEntityPackets.VoicePackQueryPacket::decode,
                BlueprintBookEntityPackets.VoicePackQueryPacket::handle);
        // v1.5.220：手册"导入建筑"——玩家选文件后把路径发服务端，复制到 blueprints 目录并注册
        CHANNEL.registerMessage(14, BlueprintBookEntityPackets.BuildImportPacket.class,
                BlueprintBookEntityPackets.BuildImportPacket::encode, BlueprintBookEntityPackets.BuildImportPacket::decode,
                BlueprintBookEntityPackets.BuildImportPacket::handle);
        // v1.5.224：手册"导入世界地图"——限 .zip（世界存档/建筑包），提取后回详细结果
        CHANNEL.registerMessage(15, BlueprintBookEntityPackets.WorldImportPacket.class,
                BlueprintBookEntityPackets.WorldImportPacket::encode, BlueprintBookEntityPackets.WorldImportPacket::decode,
                BlueprintBookEntityPackets.WorldImportPacket::handle);
        // v1.5.226：S2C 记忆开关状态同步——服务端切换后广播，客户端缓存纠正显示
        //（persistentData 不同步客户端，重开女仆配置界面开关会显示回旧值）
        CHANNEL.registerMessage(16, BlueprintBookEntityPackets.MemoryStateSyncPacket.class,
                BlueprintBookEntityPackets.MemoryStateSyncPacket::encode, BlueprintBookEntityPackets.MemoryStateSyncPacket::decode,
                BlueprintBookEntityPackets.MemoryStateSyncPacket::handle);
        // v1.5.227：C2S 记忆开关状态查询——女仆配置界面打开时主动拉取真实状态
        //（新会话首次打开时客户端缓存为空，persistentData 是旧值 → 按钮显示错）
        CHANNEL.registerMessage(17, BlueprintBookEntityPackets.MemoryStateQueryPacket.class,
                BlueprintBookEntityPackets.MemoryStateQueryPacket::encode, BlueprintBookEntityPackets.MemoryStateQueryPacket::decode,
                BlueprintBookEntityPackets.MemoryStateQueryPacket::handle);
        // v1.5.252j：建造 HUD 快照（S2C）——服务端每秒广播进行中区块的速度/预计完成时间
        CHANNEL.registerMessage(18, BlueprintBookBuildPackets.BuildHudPacket.class,
                BlueprintBookBuildPackets.BuildHudPacket::encode, BlueprintBookBuildPackets.BuildHudPacket::decode,
                BlueprintBookBuildPackets.BuildHudPacket::handle);
        // v1.5.275：请求重新打开手册（C2S 空包——配置面板"跳转女仆管理"用）
        CHANNEL.registerMessage(19, BlueprintBookBuildPackets.OpenBookRequestPacket.class,
                BlueprintBookBuildPackets.OpenBookRequestPacket::encode, BlueprintBookBuildPackets.OpenBookRequestPacket::decode,
                BlueprintBookBuildPackets.OpenBookRequestPacket::handle);
        ...
        CHANNEL.registerMessage(20, BlueprintBookEntityPackets.AiLlmTogglePacket.class,
                BlueprintBookEntityPackets.AiLlmTogglePacket::encode, BlueprintBookEntityPackets.AiLlmTogglePacket::decode,
                BlueprintBookEntityPackets.AiLlmTogglePacket::handle);
        CHANNEL.registerMessage(21, BlueprintBookEntityPackets.LlmStateSyncPacket.class,
                BlueprintBookEntityPackets.LlmStateSyncPacket::encode, BlueprintBookEntityPackets.LlmStateSyncPacket::decode,
                BlueprintBookEntityPackets.LlmStateSyncPacket::handle);
        // v1.1.0 实测八十二：蓝图投影——区块预览叠加幽灵方块轮廓（确认朝向/形状）。
        // C2S 请求点云 → 服务端抽壳降采样后 S2C 下发（客户端按 id 缓存）
        CHANNEL.registerMessage(22, BlueprintBookBuildPackets.ProjectionRequestPacket.class,
                BlueprintBookBuildPackets.ProjectionRequestPacket::encode, BlueprintBookBuildPackets.ProjectionRequestPacket::decode,
                BlueprintBookBuildPackets.ProjectionRequestPacket::handle);
        CHANNEL.registerMessage(23, BlueprintBookBuildPackets.ProjectionDataPacket.class,
                BlueprintBookBuildPackets.ProjectionDataPacket::encode, BlueprintBookBuildPackets.ProjectionDataPacket::decode,
                BlueprintBookBuildPackets.ProjectionDataPacket::handle);
        // v1.1.0 实测九十五：建造区块行每秒同步（S2C）——红色区块框 + 幽灵方块投影
        // 的持续驱动；此前 regions 只在开手册/创建计划时一次性下发，玩家关掉手册
        // 走到工地后客户端无数据，"建造此建筑里面没有显示投影"的根因
        CHANNEL.registerMessage(24, BlueprintBookBuildPackets.RegionSyncPacket.class,
                BlueprintBookBuildPackets.RegionSyncPacket::encode, BlueprintBookBuildPackets.RegionSyncPacket::decode,
                BlueprintBookBuildPackets.RegionSyncPacket::handle);
        // v1.1.0 实测四百二十：内置日语语音包播放（S2C）——只发女仆实体 id + jar 内
        // 音频文件名（如 build_done.ogg，客户端从自己 jar 取字节播放，省流量且两端一致）
        CHANNEL.registerMessage(25, BlueprintBookBuildPackets.PlayJarVoicePacket.class,
                BlueprintBookBuildPackets.PlayJarVoicePacket::encode, BlueprintBookBuildPackets.PlayJarVoicePacket::decode,
                BlueprintBookBuildPackets.PlayJarVoicePacket::handle);
        // v1.1.0 实测四百二十一：冷却可视化（S2C）——复活倒计时 / 回魂符冷却每秒
        // 快照（只发该主人名下女仆；无条目则不发，客户端超时自动清空）
        CHANNEL.registerMessage(26, BlueprintBookBuildPackets.CooldownHudPacket.class,
                BlueprintBookBuildPackets.CooldownHudPacket::encode, BlueprintBookBuildPackets.CooldownHudPacket::decode,
                BlueprintBookBuildPackets.CooldownHudPacket::handle);
    }
    ...
    public static void sendCooldownHud(net.minecraft.server.level.ServerPlayer player,
        ...
        try {
            CHANNEL.send(PacketDistributor.PLAYER.with(() -> player), new BlueprintBookBuildPackets.CooldownHudPacket(entries));
    ...
    public static void sendProgressUpdate(ServerPlayer player) {        if (player == null || !(player.m_9236_() instanceof net.minecraft.server.level.ServerLevel level)) {
        ...
        CHANNEL.send(PacketDistributor.PLAYER.with(() -> player),
                new BlueprintBookBuildPackets.ProgressUpdatePacket(
    ...
    public static void sendCatalog(ServerPlayer player) {
        ...
        CHANNEL.send(PacketDistributor.PLAYER.with(() -> player),
                new BlueprintBookBuildPackets.OpenBlueprintBookPacket(entries, collectMaidStatus(player),
    ...
    static void sendDebugResponse(ServerPlayer player, EntityMaid maid,
        ...
        CHANNEL.send(PacketDistributor.PLAYER.with(() -> player),
                new BlueprintBookEntityPackets.MaidDebugResponsePacket(uuid,
