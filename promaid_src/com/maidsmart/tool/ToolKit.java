...
final class ToolKit {
    ...
    static LivingEntity pick(EntityMaid maid, ServerLevel level, String mode) {
        ...
        if ("owner_target".equals(m)) {
            ...
            // m_21214_ = getLastHurtMob（主人最近攻击的目标；TLM DefaultMonsterType 同款用法）
            return owner == null ? null : owner.m_21214_();
        }
        ...
        List<Monster> monsters = level.m_6443_(Monster.class,
                maid.m_20191_().m_82400_(NEAREST_RANGE), e -> e.m_6084_() && maid.m_6779_(e));
