 ...
 *   实测五百零九补上了岩浆这条放行，见 blocked 内注释）；没骑乘；
 * - 且满足任一条：
...
public final class MaidPlaceGuard {
    ...
    public static boolean blocked(EntityMaid maid) {
        try {
            ...
            //      m_20071_=isInWaterRainOrBubble m_20077_=isInLava
            //      m_20159_=isPassenger f_19789_=fallDistance
            // 【实测五百零九更正】本行原注写的是"m_20069_=isInLava"——**注反了**：
            // m_20069_ 读 f_19798_（触水标志位）＝ isInWater；真 isInLava 是 m_20077_
