...
public final class CooldownHudRenderer {
    ...
    public static void onRenderGui(RenderGuiEvent.Post event) {
        ...
        for (String[] e : sorted()) {
            ...
            if (isBound(e)) {
                ...
                gg.m_280056_(font, HINT1, x + 4, y, 0xFFFFFF, true);
                y += LINE_H;
                if (y > h - LINE_H - 2) {
                    return; // 第二行放不下就只留第一行，绝不顶出屏幕
                }
                gg.m_280056_(font, HINT2, x + 4, y, 0xFFFFFF, true);
                y += LINE_H;
            }
        }
    }
     ...
     * 第二格是女仆名，第三格是相位（{@code lease}/{@code leash}={@code 牵绳}、
     * 其它=二号位悬挂），两档在文案上直接写清楚——你一眼能看出"我现在是牵着还是在下面挂着"。
     */
