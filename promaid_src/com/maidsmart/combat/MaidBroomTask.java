...
public class MaidBroomTask implements IRangedAttackTask {
    ...
    public ItemStack getIcon() {
        try {
            net.minecraft.world.item.Item broom = net.minecraftforge.registries.ForgeRegistries.ITEMS
                    .getValue(new ResourceLocation("touhou_little_maid", "broom"));
            if (broom != null) {
    ...
    private static List<Pair<Integer, BehaviorControl<? super EntityMaid>>> buildBrain() {
        ...
        list.add(Pair.of(5, net.minecraft.world.entity.ai.behavior.StartAttacking.m_257741_((EntityMaid m) -> true, 
                IRangedAttackTask::findFirstValidAttackTarget)));
        list.add(Pair.of(5, net.minecraft.world.entity.ai.behavior.StopAttackingIfTargetInvalid.m_257990_(target -> false)));
    ...
    public net.minecraft.world.phys.AABB searchDimension(EntityMaid maid) {
        if (maid.m_21536_()) {
            return new net.minecraft.world.phys.AABB(maid.m_21534_())
                    .m_82377_(BROOM_SEARCH_RADIUS, BROOM_SEARCH_RADIUS, BROOM_SEARCH_RADIUS);
        }
        return maid.m_20191_().m_82377_(BROOM_SEARCH_RADIUS, BROOM_SEARCH_RADIUS, BROOM_SEARCH_RADIUS);
    }
