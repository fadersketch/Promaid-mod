...
public final class MaidSpellCompat {
    ...
    private static String gearDetail(EntityMaid maid) {
        ...
        try {
            String hit = weaponDetail(maid.m_21205_());
            if (hit != null) {
                return hit;
            }
            hit = weaponDetail(maid.m_21206_());
            if (hit != null) {
                return hit;
            }
    ...
    private static String weaponDetail(ItemStack stack) {
        ...
        try {
            return provider + ":" + net.minecraftforge.registries.ForgeRegistries.ITEMS.getKey(stack.m_41720_());
        } catch (Throwable ignored) {
            return provider + ":?";
        }
    }
